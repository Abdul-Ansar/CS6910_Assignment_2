...
if __name__ == "__main__":
    ...
    parser.add_argument("-wp", "--wandb_project",type=str, default="de2_ge23m18", help="Enter the Name of your Wandb Project")
    parser.add_argument("-we", "--wandb_entity",type=str, default="ge23m18", help="Wandb Entity used to track experiments in the Weights & Biases dashboard.")
